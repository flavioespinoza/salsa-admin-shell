...
export class GoogleAdapter implements IAuthProvider {
  readonly name = 'google';
  readonly displayName = 'Google';
  readonly authorizeEndpoint = 'https://accounts.google.com/o/oauth2/v2/auth';
  readonly tokenEndpoint = 'https://oauth2.googleapis.com/token';
  readonly userInfoEndpoint = 'https://openidconnect.googleapis.com/v1/userinfo';
