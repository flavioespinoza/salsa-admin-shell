...
export class SlackAdapter implements IAuthProvider {
  readonly name = 'slack';
  readonly displayName = 'Slack';
  readonly authorizeEndpoint = 'https://slack.com/openid/connect/authorize';
  readonly tokenEndpoint = 'https://slack.com/api/openid.connect.token';
  readonly userInfoEndpoint = 'https://slack.com/api/openid.connect.userInfo';
