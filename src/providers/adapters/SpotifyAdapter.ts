...
export class SpotifyAdapter implements IAuthProvider {
  readonly name = 'spotify';
  readonly displayName = 'Spotify';
  readonly authorizeEndpoint = 'https://accounts.spotify.com/authorize';
  readonly tokenEndpoint = 'https://accounts.spotify.com/api/token';
  readonly userInfoEndpoint = 'https://api.spotify.com/v1/me';
  readonly scopes = ['user-read-email', 'user-read-private'];
