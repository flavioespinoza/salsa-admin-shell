...
export class LinearAdapter implements IAuthProvider {
  readonly name = 'linear';
  readonly displayName = 'Linear';
  readonly authorizeEndpoint = 'https://linear.app/oauth/authorize';
  readonly tokenEndpoint = 'https://api.linear.app/oauth/token';
  readonly userInfoEndpoint = 'https://api.linear.app/graphql';
