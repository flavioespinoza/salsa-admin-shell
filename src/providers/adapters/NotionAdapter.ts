...
export class NotionAdapter implements IAuthProvider {
  readonly name = 'notion';
  readonly displayName = 'Notion';
  readonly authorizeEndpoint = 'https://api.notion.com/v1/oauth/authorize';
  readonly tokenEndpoint = 'https://api.notion.com/v1/oauth/token';
  readonly userInfoEndpoint = 'https://api.notion.com/v1/users/me';
